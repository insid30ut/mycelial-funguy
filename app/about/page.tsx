		...
		<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
			...
			<div className="text-center mb-12">
				...
				<p className="text-lg text-[var(--color-forest-brown)] max-w-2xl mx-auto leading-relaxed">
					Welcome to my corner of the mycological universe! Let me share my
					journey from curious beginner to passionate cultivator.
				</p>
			</div>
				...
				<div className="space-y-8">
					...
					<div className="organic-card p-8">
						...
						<div className="space-y-6 text-[var(--color-forest-brown)] leading-relaxed">
							<p>
								My fascination with mushrooms began during a particularly
								stressful period in my life. I was working in tech, spending
								long hours staring at screens, feeling disconnected from the
								natural world. A friend gave me a simple oyster mushroom kit for
								my birthday, and everything changed.
							</p>

							<p>
								Watching those first tiny pins emerge from what looked like
								coffee grounds was pure magic. There was something deeply
								satisfying about nurturing life, working with my hands, and
								being part of a process that had been sustaining humanity for
								thousands of years. I was hooked immediately.
							</p>

							<p>
								What started as a single mushroom kit has evolved into a full
								cultivation setup in my basement. I've experimented with over a
								dozen species, from the forgiving oyster mushrooms to the more
								challenging shiitakes and lion's mane. Each species has taught
								me something new about patience, observation, and the incredible
								complexity of fungal biology.
							</p>

							<p>
								My current setup includes multiple fruiting chambers, a
								dedicated sterile workspace, and enough agar plates to stock a
								small laboratory. I source materials locally when possible,
								building relationships with coffee shops for spent grounds and
								arborists for fresh logs. Sustainability isn't just a buzzword
								for me—it's a core part of how I approach cultivation.
							</p>

							<p>
								Through this blog, I want to share the real, unfiltered
								experience of home cultivation. The successes and failures, the
								unexpected discoveries, and the deep satisfaction that comes
								from growing your own food. Whether you're just starting out or
								looking to refine your techniques, I hope my experiences can
								help guide your own mycological journey.
							</p>
						</div>
					</div>
					...
					<div className="organic-card p-6 border-l-4 border-[var(--color-electric-blue)]">
						...
						<div className="space-y-3">
							<div className="flex items-center">
								...
								<span className="text-[var(--color-forest-brown)]">
									Perfecting liquid culture techniques
								</span>
							</div>
							<div className="flex items-center">
								<div className="w-2 h-2 rounded-full bg-[var(--color-neon-pink)] mr-3"></div>
								<span className="text-[var(--color-forest-brown)]">
									Experimenting with wine cap outdoor cultivation
								</span>
							</div>
							<div className="flex items-center">
								<div className="w-2 h-2 rounded-full bg-[var(--color-deep-purple)] mr-3"></div>
								<span className="text-[var(--color-forest-brown)]">
									Building a climate-controlled growing environment
								</span>
							</div>
							<div className="flex items-center">
								<div className="w-2 h-2 rounded-full bg-[var(--color-bright-orange)] mr-3"></div>
								<span className="text-[var(--color-forest-brown)]">
									Documenting strain variations and performance
								</span>
							</div>
						</div>
					</div>
				...
				<div className="space-y-8">
					...
					<div className="organic-card p-6">
						...
						<p className="text-[var(--color-forest-brown)] text-center mb-6">
							I love connecting with fellow cultivators, sharing experiences,
						...
						<div className="grid grid-cols-2 gap-4">
							<div className="text-center p-4 bg-gradient-to-br from-[var(--color-warm-cream-light)] to-[var(--color-warm-cream)] rounded-xl">
								...
								<h4 className="font-semibold text-[var(--color-forest-brown-dark)]">
									Questions
								</h4>
								<p className="text-xs text-[var(--color-forest-brown)]">
									Technique help
								</p>
							</div>
					...
					<div className="organic-card p-6 bg-gradient-to-r from-[var(--color-electric-blue)]/10 to-[var(--color-deep-purple)]/10">
						...
						<div className="space-y-3 text-sm">
							<div className="flex items-center justify-between p-3 bg-white/50 rounded-lg">
								...
								<span className="font-bold text-[var(--color-electric-blue)]">
									12+
								</span>
							</div>
							<div className="flex items-center justify-between p-3 bg-white/50 rounded-lg">
								...
								<span className="font-bold text-[var(--color-bright-orange)]">
									2.5
								</span>
							</div>
							<div className="flex items-center justify-between p-3 bg-white/50 rounded-lg">
							...
							<div className="flex items-center justify-between p-3 bg-white/50 rounded-lg">
								...
								<span className="font-bold text-[var(--color-neon-pink)]">
									Lion's mane
								</span>
							</div>
						</div>
