...
const HomePage: React.FC = () => {
	// Renamed to HomePage for consistency with Next.js page naming
	return (
				...
				<div className="relative">
					...
					<div className="max-w-3xl mx-auto mb-12">
						<p className="text-lg sm:text-xl text-[var(--color-forest-brown)] leading-relaxed font-medium">
							Welcome to my personal journey through the fascinating world of
							mushroom cultivation. Here I share my hands-on experiences,
							discoveries, and favorite products that have transformed my
							growing practice. Whether you're a curious beginner or seasoned
							cultivator, join me in exploring the magical realm of fungi.
						</p>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
						...
						<div className="organic-card p-6 text-center">
							...
							<p className="text-[var(--color-forest-brown)] text-sm">
								Read about my cultivation adventures, successes, failures, and
						...
						<div className="organic-card p-6 text-center">
							...
							<p className="text-[var(--color-forest-brown)] text-sm">
								Step-by-step tutorials and techniques that I've tested and
								refined in my own growing practice.
							</p>
						</div>
						...
						<div className="organic-card p-6 text-center">
							...
							<p className="text-[var(--color-forest-brown)] text-sm">
								Connect with fellow cultivators and share your own experiences
